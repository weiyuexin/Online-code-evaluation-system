...
export default {
    ...
    data() {
        return {
            blogs: [{
                title: '[S1018] 二叉树 题解',
                content: '观察题目，我们可以考虑一个贪心策略：对于每一个节点，',
                author: 'wyx',
                comments: 7,
                stars: 9,
                view: 89,
...
.blog {
//-moz-border-radius-bottomleft: 6px; //-moz-border-radius-bottomright: 6px; //-webkit-box-shadow: 0 2px 12px 0 rgb(0 0 0 / 10%); //box-shadow: 0 2px 12px 0 rgb(0 0 0 / 10%); width: 100%; height: 150px; background-color: #FFF;
    margin-top: 10px;
    border-radius: 5px;
}
